...
public class AutoMazeTest {
    ...
    public void mazeDirectTest() {
        AutoMaze maze = new AutoMaze("examples/direct.maz.txt", logger);
    ...
    public void mazeSmallTest() {
        AutoMaze maze = new AutoMaze("examples/small.maz.txt", logger);
        String result = maze.runPath();
    ...
    public void mazeMediumTest() {
        AutoMaze maze = new AutoMaze("examples/medium.maz.txt", logger);
        String result = maze.runPath();
    ...
    public void mazeRectangleTest() {
        AutoMaze maze = new AutoMaze("examples/rectangle.maz.txt", logger);
        String result = maze.runPath();
